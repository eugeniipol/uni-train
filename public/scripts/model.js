...
const model = (function () {
      ...
      xhr.onload = function () {
        if (this.status === 200) {
          ...
          for (let i = 0; i < newMassive.length; i++) {
            ...
            const div = createPostDom(newMassive[i].author, newMassive[i].description, newMassive[i].photolink, newMassive[i].hashtags, newMassive[i].likes, newMassive[i].createdAt, newMassive[i].id, newMassive[i].del);
            nodes[i] = div;
          }
          resolve(this.response);
        } else {
  ...
  function createPostDom(author, descript, link, hashtags, likes, createdAt, id, del) {
    ...
    const delPhoto = document.createElement('img');
    ...
    const editPhoto = document.createElement('img');
